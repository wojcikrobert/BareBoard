...
__attribute__((used,section(".nvic_vector"))) void (* const nvic_Vector[])(void)= {
   (void *)&_STACKTOP,
   ...
   RTC_WKUP_IRQHandler,               // RTC Wake up through the EXTI line
   ...
   OTG_FS_WKUP_IRQHandler,            // USB OTG FS Wake up through EXTI line
   ...
   ETH_WKUP_IRQHandler,               // Ethernet Wake up through EXTI line
   ...
   OTG_HS_WKUP_IRQHandler,            // USB OTG HS Wake up through EXTI
